...
class InstituteSplash extends StatelessWidget {
  const InstituteSplash({super.key});

  @override
  Widget build(BuildContext context) {
    Future.delayed(Duration(seconds: 7),(){
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>LoginInstitution()));});
    return  Scaffold(
      body: Container(
